...
class Tx:
    ...
    def __repr__(self) -> str:
        ...
        return "Tx(from={}, to={}, data={}, sig={})".format(self.from_acc, self.to_acc, self.data.hex(), sig_str)
...
def decode_tx_yaml(txt):
    ...
    # parse into binary
    # data['from'] = bytes.fromhex(data['from'])
    # data['to'] = bytes.fromhex(data['to'])
    data['data'] = bytes.fromhex(data['data'])
    data['sig'] = bytes.fromhex(data['sig'])
